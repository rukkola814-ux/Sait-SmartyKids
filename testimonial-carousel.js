...
(function () {
  ...
  var avatarSrc = "testimonial-avatar.png";
  ...
  var testimonials = [
    ...
    {
      id: 3,
      name: "Ирина, мама 3 детей",
      avatar: avatarSrc,
      description:
        "«Мои дети 4-х лет, 10 лет, 13 лет с удовольствием посещают занятия. Потрясающая обстановка в самом клубе, великолепное отношение к детям.»",
    },
  ];
